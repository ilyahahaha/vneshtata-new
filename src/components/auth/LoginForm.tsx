...
const LoginForm: React.FC = () => {
  ...
  const useLogin = trpc.user.login.useMutation()
              ...
              <div className="relative">
                <input
                  ...
                  className={clsx(
                    ...
                    'appearance-none rounded-none rounded-t-md relative block w-full px-3 py-2 border focus:outline-none focus:z-10 sm:text-sm'
                  )}
                  placeholder="Email"
